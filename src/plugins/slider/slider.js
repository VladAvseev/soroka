...
function sliderCreate(options) {
    ...
    function checkButtons() {
        if (position === 0) {
            $btnPrev.classList.add('block-slider-btn');
        } else {
            $btnPrev.classList.remove('block-slider-btn');
        }
        if (position <= -(itemsCount - slidesToShow) * itemWidth) {
            $btnNext.classList.add('block-slider-btn');
        } else {
            $btnNext.classList.remove('block-slider-btn');
        }
    }
